      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load5() {
            ...
            store.setParamTypes(pl.pdfviewer.client.ui.PdfViewerServerRpc.class, "angleChange", new Type[] {new Type(java.lang.Integer.class), });
            store.setParamTypes(pl.pdfviewer.client.ui.PdfViewerServerRpc.class, "download", new Type[] {});
            store.setParamTypes(pl.pdfviewer.client.ui.PdfViewerServerRpc.class, "pageChange", new Type[] {new Type(java.lang.Integer.class), });
          ...
          private void load6() {
            ...
            store.setProxyHandler(pl.pdfviewer.client.ui.PdfViewerServerRpc.class, new com.vaadin.client.metadata.ProxyHandler() {
              public Object createProxy(final com.vaadin.client.metadata.InvokationHandler handler) {
                return new pl.pdfviewer.client.ui.PdfViewerServerRpc() {
                  public void angleChange(java.lang.Integer p0) {
                    handler.invoke(this, com.vaadin.client.metadata.TypeData.getType(pl.pdfviewer.client.ui.PdfViewerServerRpc.class).getMethod("angleChange"), new Object [] {p0, });
                  }
                  public void download() {
                    handler.invoke(this, com.vaadin.client.metadata.TypeData.getType(pl.pdfviewer.client.ui.PdfViewerServerRpc.class).getMethod("download"), new Object [] {});
                  }
                  public void pageChange(java.lang.Integer p0) {
                    handler.invoke(this, com.vaadin.client.metadata.TypeData.getType(pl.pdfviewer.client.ui.PdfViewerServerRpc.class).getMethod("pageChange"), new Object [] {p0, });
                  }
                };
              }
            });
            ...
            store.setPropertyType(pl.pdfviewer.client.share.PdfViewerState.class, "additionalVisible", new Type(java.lang.Boolean.class));
            ...
            store.setPropertyType(pl.pdfviewer.client.share.PdfViewerState.class, "angle", new Type(java.lang.Integer.class));
            store.setPropertyType(pl.pdfviewer.client.share.PdfViewerState.class, "angleVisible", new Type(java.lang.Boolean.class));
          ...
          private void load10() {
            ...
            store.addOnStateChangeMethod(pl.pdfviewer.client.ui.PdfViewerConnector.class, new com.vaadin.client.metadata.OnStateChangeMethod(com.vaadin.client.ui.AbstractComponentConnector.class, "setErrorLevel", new String[] {"errorMessage", "errorLevel", }));
          ...
          private native void loadNativeJs(com.vaadin.client.metadata.TypeDataStore store) /*-{
            ...
            var data = {
              setter: function(bean, value) {
                bean.@pl.pdfviewer.client.share.PdfViewerState::additionalVisible = value.@java.lang.Boolean::booleanValue()();
              },
              getter: function(bean) {
                return @java.lang.Boolean::valueOf(Z)(bean.@pl.pdfviewer.client.share.PdfViewerState::additionalVisible);
              }
            };
            ...
            var data = {
              setter: function(bean, value) {
                bean.@pl.pdfviewer.client.share.PdfViewerState::angle = value.@java.lang.Integer::intValue()();
              },
              getter: function(bean) {
                return @java.lang.Integer::valueOf(I)(bean.@pl.pdfviewer.client.share.PdfViewerState::angle);
              }
            };
            store.@com.vaadin.client.metadata.TypeDataStore::setPropertyData(Ljava/lang/Class;Ljava/lang/String;Lcom/google/gwt/core/client/JavaScriptObject;)(@pl.pdfviewer.client.share.PdfViewerState::class, 'angle', data);
            
            var data = {
              setter: function(bean, value) {
                bean.@pl.pdfviewer.client.share.PdfViewerState::angleVisible = value.@java.lang.Boolean::booleanValue()();
              },
              getter: function(bean) {
                return @java.lang.Boolean::valueOf(Z)(bean.@pl.pdfviewer.client.share.PdfViewerState::angleVisible);
              }
            };
