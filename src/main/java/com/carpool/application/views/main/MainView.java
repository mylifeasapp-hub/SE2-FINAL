package com.carpool.application.views.main;
...
import com.carpool.application.views.login.LoginView;

/**
 * The main view is a top-level placeholder for other views.
 */
@JsModule("./styles/shared-styles.js")
@PWA(name = "CARPOOL", shortName = "CARPOOL",  enableInstallPrompt = false)
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "CARPOOL logo"));
        logoLayout.add(new H1("CARPOOL"));
